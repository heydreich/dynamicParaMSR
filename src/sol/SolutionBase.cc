...
int SolutionBase::getReplacementNode(int stripeid, string scenario, vector<int> & avoid_node_ids, vector<vector<int>> & loadTable){
    int repair_node_id;
    if(scenario == "scatter"){
        ...
        // cout << "stripeid = " << stripeid << endl;
        // cout << "standby size = " << _standby_size << endl;
    ...
    cout << "debug choose replacement node: " << repair_node_id << endl;
