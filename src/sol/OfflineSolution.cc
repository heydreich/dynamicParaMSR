...
void OfflineSolution::genRepairBatchesForSingleFailure(int fail_node_id, string scenario, bool enqueue) {
    ...
    cout << "OfflineSolution::genRepairBatchesForSingleFailure.fail_node_id = " << fail_node_id << endl;
    ...
    cout << "OfflineSolution::genRepairBatchesForSingleFailure.num batches = " << _num_batches << endl;
